...
Local C2g focused validation is **86 tests passed, no skips**. The lightweight matrix and ordinary PR secured run are pending this revision. Do not claim a complete remote matrix inventory until that run finishes. Rust SDK compatibility, C3, C4, activation, and live deployment remain deferred.
