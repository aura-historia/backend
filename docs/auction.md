...
Raw normalization and typed partner listing writes use the same transactional embedded-metadata policy: fill only an absent, unprotected shared field. Equal, protected, and conflicting candidates do not replace shared facts.
