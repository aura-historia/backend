...
The `crawler` crate is an async, LLM-assisted web crawler for antiques e-commerce shops. It discovers product URLs across shop websites (spider) and extracts structured product data from each product page (scraper).

## Contents

| File | What it covers |
|------|---------------|
| [architecture.md](architecture.md) | CronJob, Spider, Scraper — how they work and how they connect |
...
- **CrawlerCronJob** — drives both loops; selects candidates from DB; fans out work with bounded concurrency
