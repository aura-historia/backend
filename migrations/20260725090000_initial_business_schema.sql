...
CREATE TABLE product_listings (
    ...
    CONSTRAINT product_listings_state_check CHECK (state IN ('LISTED', 'AVAILABLE', 'RESERVED', 'SOLD', 'REMOVED', 'UNKNOWN')),
    CONSTRAINT product_listings_lifecycle_check CHECK (lifecycle IN ('ACTIVE', 'DELETED')),
    ...
    CONSTRAINT product_listings_sale_valuation_state_check CHECK (sale_fx_rate_id IS NULL OR state IN ('SOLD', 'REMOVED')),
    CONSTRAINT product_listings_sold_sale_valuation_check CHECK (state <> 'SOLD' OR sale_fx_rate_id IS NOT NULL),
