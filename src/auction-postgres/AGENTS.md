...
- Own PostgreSQL Auction repository, flat schedule columns, event journal, and details readers.

## Core Design

- Rows and SQL stay private. Rehydration validates all persisted IDs, values, enum codes, localization pairs, and schedule bounds. Details and directory reads use flat schedule columns with each Auction root.
