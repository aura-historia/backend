...
- Owns reusable typed generation contracts plus a Vertex AI Gemini implementation, credentials, request timeout, provider errors, response extraction, provider/model/service-tier vocabulary, invocation metrics, and safe invocation logging.
