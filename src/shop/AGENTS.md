...
- Legacy `core::shop::Shop` and `service::{command,command_service,get_service,query_service}` stay until cutover.
- Canonical migration code moved to `shop-core` and `shop-service` crates.
