...
- Canonical shop derives `view_url` from canonical URL plus affiliate config; `UpdateShop` uses shared tri-state fields, calls explicit domain methods, and lets repository bump version once.
