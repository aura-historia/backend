use super::types::{PartnerProductFailureData, UpsertProductData};
...
pub async fn upsert_products(
    ...
    let products: Vec<UpsertProductData> = match parse_body(&body) {
...
fn parse_body(body: &str) -> Result<Vec<UpsertProductData>, ApiError> {
