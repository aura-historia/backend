use super::types::{PartnerProductFailureData, UpdateProductData};
...
pub async fn update_products(
    ...
    let products: Vec<UpdateProductData> = match parse_body(&body) {
...
fn parse_body(body: &str) -> Result<Vec<UpdateProductData>, ApiError> {
