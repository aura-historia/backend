        ...
        .map(|product| {
            ...
            Personalized {
                item: ProductListingSummary {
                    ...
                    lot_bidding_opens_at: product.item.item.lot_bidding_opens_at,
                    lot_scheduled_closes_at: product.item.item.lot_scheduled_closes_at,
                    lot_reported_closed_at: product.item.item.lot_reported_closed_at,
