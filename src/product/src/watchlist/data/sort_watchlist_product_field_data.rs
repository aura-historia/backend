use crate::watchlist::service::sort_watchlist_product_field::SortWatchlistItemField;
...
#[cfg(test)]
mod tests {
    use crate::watchlist::data::sort_watchlist_product_field_data::SortWatchlistItemFieldData;
