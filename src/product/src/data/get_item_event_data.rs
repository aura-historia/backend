...
use common::{
    event::Event, event_id::EventId, product_id::ProductId, price::data::PriceData, shop_id::ShopId,
...
impl From<Event<ProductId, LocalizedItemEventPayloadView>> for GetItemEventData {
