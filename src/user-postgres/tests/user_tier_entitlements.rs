...
async fn seed_watchlist_entries(
    ...
    for index in 0..count {
        ...
        sqlx::query(
            "INSERT INTO product_listings (product_listing_id, product_listing_slug_id, event_id, content_source_event_id, listing_source_id, source_listing_id, availability, lifecycle, url) VALUES ($1, $2, $3, $3, $4, $5, 'AVAILABLE', 'ACTIVE', 'https://example.com/product-listings')",
        )
        .bind(product_listing_id)
