...
- Repository writes return persisted watchlist state with a service-owned storage version; updates and deletes enforce optimistic concurrency. Query failures retain causes; expected conflicts do not.
