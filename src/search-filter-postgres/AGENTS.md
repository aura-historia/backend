...
- Owns focused periodic-match candidate, existing-match, progress, and dedicated-session advisory-lock adapters. Periodic state remains separate from ordinary Search Filter views.
