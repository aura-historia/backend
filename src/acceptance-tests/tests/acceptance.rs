...
async fn should_respond_200_when_product_search_hits_authenticated() {
    ...
    let expected = ProductDocument {
        ...
        price_cny: Some(1990000),
        price_brl: Some(1990000),
        price_pln: Some(1990000),
        price_try: Some(1990000),
        price_jpy: Some(1990000),
        price_czk: Some(1990000),
        price_rub: Some(1990000),
        price_aed: Some(1990000),
        price_sar: Some(1990000),
        price_hkd: Some(1990000),
        price_sgd: Some(1990000),
        price_chf: Some(1990000),
        price_cny: Some(1990000),
        price_brl: Some(1990000),
        price_pln: Some(1990000),
        price_try: Some(1990000),
        ...
        price_estimate_min_cny: Faker.fake(),
        price_estimate_min_brl: Faker.fake(),
        price_estimate_min_pln: Faker.fake(),
        price_estimate_min_try: Faker.fake(),
        price_estimate_min_jpy: Faker.fake(),
        price_estimate_min_czk: Faker.fake(),
        price_estimate_min_rub: Faker.fake(),
        price_estimate_min_aed: Faker.fake(),
        price_estimate_min_sar: Faker.fake(),
        price_estimate_min_hkd: Faker.fake(),
        price_estimate_min_sgd: Faker.fake(),
        price_estimate_min_chf: Faker.fake(),
        price_estimate_min_cny: Faker.fake(),
        price_estimate_min_brl: Faker.fake(),
        price_estimate_min_pln: Faker.fake(),
        price_estimate_min_try: Faker.fake(),
        ...
        price_estimate_max_cny: Faker.fake(),
        price_estimate_max_brl: Faker.fake(),
        price_estimate_max_pln: Faker.fake(),
        price_estimate_max_try: Faker.fake(),
        price_estimate_max_jpy: Faker.fake(),
        price_estimate_max_czk: Faker.fake(),
        price_estimate_max_rub: Faker.fake(),
        price_estimate_max_aed: Faker.fake(),
        price_estimate_max_sar: Faker.fake(),
        price_estimate_max_hkd: Faker.fake(),
        price_estimate_max_sgd: Faker.fake(),
        price_estimate_max_chf: Faker.fake(),
        price_estimate_max_cny: Faker.fake(),
        price_estimate_max_brl: Faker.fake(),
        price_estimate_max_pln: Faker.fake(),
        price_estimate_max_try: Faker.fake(),
