...
pub struct AdminUpdatePartnerShopApplicationHandler<U, A> {
    unit_of_work: U,
    applications: A,
}

impl<U, A> AdminUpdatePartnerShopApplicationHandler<U, A> {
...
#[async_trait::async_trait]
impl<U, A> AdminUpdatePartnerShopApplicationUseCase
    for AdminUpdatePartnerShopApplicationHandler<U, A>
where
    U: UnitOfWork,
