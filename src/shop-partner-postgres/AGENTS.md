...
- Depends on `shop-partner-core`, `shop-partner-service`, `shop-service`, and shared `platform-postgres` UoW; it does not depend on the concrete `shop-postgres` adapter.
