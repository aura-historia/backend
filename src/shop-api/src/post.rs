...
pub async fn handle(
    ...
    let create_command = CreateShopCommand {
        ...
        shopify_language: post_data.shopify_language.map(Into::into),
        woocommerce_webhook_secret: post_data.woocommerce_webhook_secret,
        woocommerce_currency: post_data.woocommerce_currency.map(Into::into),
        woocommerce_language: post_data.woocommerce_language.map(Into::into),
        url: post_data.url,
