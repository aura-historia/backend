...
- Root modules: `currency_record`, `language_record`, `price_record`, `notification_record`, `notification_record_update`, `notification_reason_record`, `notification_type_record`, `repository`, `list_notifications_reader`, `all_notifications_reader`, `product_notifications_reader`, `batch_writer`, `batch`, `dynamodb_update`, `deleter`. The DynamoDB request and batch helpers stay private to this adapter.
