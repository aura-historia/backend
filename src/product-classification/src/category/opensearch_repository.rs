                        ...
                        "should": [
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": [
                                        format!("{}^8", CategoryDocumentSerdeField::MetaName.as_str()),
                                        format!("{}^5", CategoryDocumentSerdeField::MetaKeywords.as_str()),
                                        format!("{}^3", CategoryDocumentSerdeField::MetaDescription.as_str()),
                                    ],
                                    "type": "best_fields",
                                    "fuzziness": "AUTO",
    ...
    async fn search_category_documents(
        ...
        if let Some(query) = search.name_query.as_ref() {
            let name_field = match search.language {
                ...
                _ => CategoryDocumentSerdeField::DisplayNameEn.as_str(),
            };
            must.push(json!({
                "multi_match": {
                    "query": query,
