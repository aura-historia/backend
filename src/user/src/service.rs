use crate::{command::CreateUserCommand, repository::UserDynamoDbRepository, user::User};
...
mod tests {
    ...
    mod find_user {
        ...
        use crate::{repository::MockUserDynamoDbRepository, service::UserServiceError};
