...
- Child crates: `product-lambda-ingest-partner-products`, `product-lambda-materialize-opensearch`, `product-lambda-update-notify-user`.
- Main neighbors: `product-lambda-ingest-partner-products`, `product-lambda-materialize-opensearch`, `product-lambda-update-notify-user`.
