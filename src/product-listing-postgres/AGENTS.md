...
- `cargo test -p product-listing-postgres --test product_listing_raw_normalization --all-features` covers raw stream persistence and ProductListing-only normalization.
