use crate::normalization::state::{ProductStateMappingRecord, StateMappingType};
use crate::normalization::state_mapping_repository::ProductStateMappingRepository;
...
mod tests {
    use super::*;
    use crate::normalization::state_mapping_repository::MockProductStateMappingRepository;
    use product::dynamodb::product_state_record::ProductStateRecord;
    use rstest::rstest;
