...
- `product_listing_raw_normalization.rs` consumes compact raw-revision wake-ups, invokes `product-service` normalization, and performs startup plus periodic bounded PostgreSQL reconciliation. Raw JSON never enters this queue.
