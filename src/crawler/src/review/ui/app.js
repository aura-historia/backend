      ...
      <div class="editor-panel">
        ...
        <div style="padding:10px">
          ...
          <div class="selector-box">
            ...
            <button onclick="saveCurrentField()">Save field</button>
...
function currentSchema() {
    return (((selectedDetail.review || {}).candidate_payload || {}).schemas || [])[selectedSchemaIndex] || {};
}
