...
fn demo_shops() -> Vec<RegisteredShop> {
    ...
    // These demo domains intentionally focus on small and medium antique
    // marketplaces, directories, and independent commercial dealers.
    [
        (
            1,
            "Proantic",
        ...
        (
            ...
            "david-wolfenden-antiques",
            "www.davidwolfendenantiques.com",
            ShopType::CommercialDealer,
        ),
        (
            19,
