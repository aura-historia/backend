...
fn demo_shops() -> Vec<RegisteredShop> {
    ...
    // These demo domains intentionally cover marketplaces, auction platforms,
    // auction houses, architectural salvage shops, and vintage jewelry dealers.
    [
        (
            1,
            "Ruby Lane",
