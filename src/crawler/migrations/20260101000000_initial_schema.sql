...
CREATE TABLE IF NOT EXISTS shop_urls (
    ...
    last_scraped_state                TEXT        NOT NULL DEFAULT 'UNKNOWN',
    ...
    last_scraped_origin_year          TEXT,
    last_scraped_authenticity         TEXT,
    last_scraped_condition            TEXT,
    last_scraped_provenance           TEXT,
    last_scraped_restoration          TEXT,
    ...
    CHECK (last_scraped_state IN ('LISTED', 'AVAILABLE', 'RESERVED', 'SOLD', 'REMOVED', 'UNKNOWN')),
    PRIMARY KEY (url)
);
