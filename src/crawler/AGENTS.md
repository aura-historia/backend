...
- Product schemas may generate raw shipping attribute selectors for review/demo/file inspection only. Extracted raw values are not DB or product-command data.
