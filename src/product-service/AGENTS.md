...
- `CaptureFxRateSnapshot` fetches FxRatesApi EUR quotes before opening a short Postgres transaction, validates a complete immutable Product FX snapshot, then persists it idempotently by EventBridge event ID.
