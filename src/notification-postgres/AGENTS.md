...
- Private rows and JSON payload mapping reconstruct typed Notification content. V1 watchlist availability payloads keep `STATE_CHANGE` plus `old_state`/`new_state` keys with canonical availability codes.
