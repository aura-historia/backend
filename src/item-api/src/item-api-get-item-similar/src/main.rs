...
async fn main() -> Result<(), Error> {
    ...
    let item_opensearch_repository = ItemOpenSearchRepositoryImpl::new(&opensearch_client);
    let item_dynamodb_repository = ItemDynamoDbRepositoryImpl::new(&dynamodb_client, &table_name);
