...
async fn should_return_202_when_products_updated_successfully() {
...
#[tokio::test]
async fn should_return_401_when_access_token_is_invalid_for_patch() {
    let shop_id = common::shop_id::ShopId::new();
    let mut get_shop_service = MockGetShopService::default();
...
#[tokio::test]
async fn should_return_403_when_user_is_not_associated_with_shop_for_patch() {
    let shop_id = common::shop_id::ShopId::new();
