...
async fn seed_product(pool: &sqlx::PgPool) -> ProductListingId {
    ...
    sqlx::query("INSERT INTO product_listings (product_listing_id, product_listing_slug_id, event_id, content_source_event_id, listing_source_id, source_listing_id, availability, lifecycle, url, source_listing_slug_id) VALUES ($1, $2, $3, $3, $4, $5, NULL, 'ACTIVE', 'https://example.test/product', $6)")
        .bind(product_uuid)
