...
- Search filter timestamps live on reader/index views, not aggregates. Periodic matcher progress is separate PostgreSQL operational state exposed only through focused service ports; ordinary Search Filter views do not expose it.
