...
use partnership_postgres::SqlxPartnershipDetailsReaderFactory;
use partnership_service::{
    ports::{PartnershipDetailsReader, PartnershipDetailsReaderFactory},
    use_cases::queries::get_admin_partnership::AdminPartnershipDetailsView,
};
