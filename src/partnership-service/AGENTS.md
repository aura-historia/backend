...
- Admin ListingSource grants authorize the actor, verify the Partnership and ListingSource in one transaction, require their Party IDs to match, commit explicitly, and report changed versus no-op outcomes for structured audit logs.
